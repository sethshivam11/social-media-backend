...
const initialState = {
  posts: [],
  createPost: (post: { caption: string; media: File; tags?: string }) => {
    post;
  },
  ...
  addToTags: (postId: string, tags: string[]) => {
    postId;
    tags;
  },
  removeFromTags: (postId: string, tags: string[]) => {
    postId;
    tags;
  },

  fetchPostComments: (postId: string, page?: number) => {
    postId;
    page;
  },
...
const PostContext = React.createContext<PostContext>(initialState);

export default function PostProvider(props: React.PropsWithChildren<{}>) {
